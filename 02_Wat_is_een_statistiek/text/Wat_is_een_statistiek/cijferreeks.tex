...
\begin{tikzpicture}[
	x=\linewidth,y=1cm,
	reeks/.style={softsteelblue,fill=mistgray,rounded corners=5mm,line width=1pt},
	reeksnaam/.style={anchor=south west,softsteelblue,inner sep=0pt,yshift=3pt,xshift=3mm},
	tabel/.style={draw=deepslateblue,fill=lightskyblue,rounded corners=2mm,text=white,align=center,inner sep=1.5ex,line width=.5pt},
