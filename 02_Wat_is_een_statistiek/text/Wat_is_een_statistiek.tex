...
\section[Statistiek als een cijfer]{Statistiek als een cijfer}
...
Statistiek gaat dus niet alleen over het berekenen van cijfers, ook wel \emph{data} genoemd\marginpar{\includegraphics[width=\linewidth]{\subfiledir/datavsmetadata.pdf}}. Statistiek gaat ook over het beheer van allerhande informatie die bij de cijfers hoort. Deze informatie noemen we de \emph{metadata} (in SDMX-terminologie ook wel \emph{attributen} van de cijfers genoemd \ref{referenitie toevoegen SDMX} ). Een \emph{statistiek} bestaat dus altijd uit twee onlosmakelijke elementen: data én metadata. Beiden zijn even belangrijk en vormen één geheel \parencite{Wild2018What}. In deze paragraaf gaan we dieper in op verschillende belangrijke vormen van metadata. 
...
\includegraphics[width=\linewidth]{\subfiledir/operationaliseren.pdf}
\end{table}
...
We zagen reeds dat een statistiek ontstaat vanuit gebruikersbehoeften en dat deze behoeften worden vertaald naar een conceptuele definitie en vervolgens een operationele definitie. In een ideale situatie zijn de conceptuele en operationele definitie afgestemd op de gebruikersbehoeften. Wanneer dat niet het geval is, heeft de statistiek een \emph{kwaliteitsprobleem}.\marginpar{\includegraphics[width=\linewidth]{\subfiledir/kwaliteit.pdf}}
...
\section[Statistiek als een cijfertabel]{Statistiek als\\een cijfertabel}
...
\includegraphics[width=\linewidth]{\subfiledir/voorbeeldcijfertabel.pdf}
\end{table}
...
\includegraphics[width=\linewidth]{\subfiledir/voorbeeldcijfertabel2.pdf}
\end{table}	
...
\section[Statistiek als een tabelreeks]{Statistiek als\\een tabelreeks}
...
\includegraphics[width=\linewidth]{\subfiledir/voorbeeldtabelreeks.pdf}
\end{table}	
...
\includegraphics[width=\linewidth]{\subfiledir/cijferreeks.pdf}
\end{figure}	
