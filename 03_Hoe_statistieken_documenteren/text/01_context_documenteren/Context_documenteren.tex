...
Volgens de richtlijnen van de \textcite{oecd2017trust} kan vertrouwen in de overheid conceptueel worden opgevat als de mate waarin inwoners vertrouwen hebben in verschillende bestuursniveaus en publieke instellingen. Vanuit deze definitie volgt dat cijfertabellen minstens het onderscheid tussen deze bestuursniveaus en instellingen als dimensie onderscheiden.

Een alternatieve conceptualisatie, die inspeelt op dezelfde abstracte gebruikersbehoefte, vertrekt niet van specifieke overheden of instellingen, maar van onderliggende maatschappelijke normen. De \textcite{oecd2017trust} stelt dat vertrouwen in publieke instellingen wordt gevormd door zowel de competentie van de overheid (zoals responsiviteit en betrouwbaarheid) als door de gehanteerde waarden (zoals openheid, integriteit en eerlijkheid). In deze benadering wordt vertrouwen dus opgevat als een evaluatie van het functioneren van overheidsinstellingen in het algemeen. Dit leidt tot cijfertabellen waarin maatschappelijke normen als dimensie worden opgenomen, in plaats van het onderscheid tussen bestuursniveaus of publieke instellingen.
