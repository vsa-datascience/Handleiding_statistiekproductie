...
\end{itemize}
Bij internationale verplichtingen is er vaak slechts beperkte flexibiliteit om de statistiek verder te operationaliseren. De verplichtingen bevatten meestal een vrij gestandaardiseerde richtlijn over de manier waarop data moet worden verzameld en cijfers moeten worden berekend. Omwille van praktische regels is het natuurlijk niet altijd mogelijk om deze richtlijnen te volgen en worden openbare statistiekdiensten toegestaan af te wijken. Dat gebeurt wel steeds in overleg met de internationale instantie zelf.
...
\item Welke van deze concepten fungeren als dimensies van de tabellen?
...
Als voorbeeld kijken we naar de Vlaamse Openbare Statistiek (VOS) ``Bevolking: omvang en groei''. Een mogelijke conceptuele definitie van deze VOS is: ``De bevolkingsomvang en -groei in het Vlaams Gewest en de Vlaamse gemeenten doorheen de jaren''. Op basis van de gebruikersbehoeften onderscheiden we binnen deze VOS drie cijfertabellen:
\begin{itemize}[nosep]
...
\end{itemize}
De opname en productie van elk van deze tabellen wordt telkens gemotiveerd en gekaderd vanuit de geformuleerde gebruikersbehoeften.
...
De conceptualisatie van gebruikersbehoeften rond bevolkingsgrootte is relatief rechttoe rechtaan. Bij andere statistieken kunnen gebruikersbehoeften veel abstracter zijn, waardoor de formulering van conceptuele definities meer werk vraagt en soms moeilijke keuzes meebrengt. Een voorbeeld van zo’n abstracte gebruikersbehoefte is de vraag naar statistieken rond het vertrouwen van burgers in de overheid. Deze behoefte is breed en weinig gestructureerd: gebruikers weten welk maatschappelijk fenomeen ze beter willen begrijpen, maar niet hoe dit fenomeen statistisch het best kan worden gevat. Om deze behoefte te vertalen naar een hanteerbare conceptuele definitie, moet eerst worden afgesproken wat in deze context onder ``vertrouwen'' wordt verstaan en hoe burgers dat vertrouwen tot uitdrukking brengen.

Volgens de richtlijnen van de \textcite{oecd2017trust} kan vertrouwen in de overheid conceptueel worden gedefinieerd als de mate waarin inwoners vertrouwen hebben in verschillende bestuursniveaus en publieke instellingen. Vanuit deze definitie volgt dat de cijfertabellen minstens het onderscheid tussen deze verschillende bestuursniveaus en instellingen als dimensie moeten bevatten. Een alternatieve conceptualisatie, die ook aansluit bij dezelfde abstracte gebruikersbehoefte, bestaat erin vertrouwen op te splitsen naar onderliggende maatschappelijke normen. De \textcite{oecd2017trust} stelt dat het vertrouwen van burgers in publieke instellingen wordt gevormd door competentie van de overheid (zoals responsiviteit en betrouwbaarheid) en waarden (zoals openheid, integriteit en eerlijkheid). In deze benadering wordt vertrouwen dus niet opgevat als een oordeel over een specifieke overheid of instelling, maar als een evaluatie van hoe overheidsinstellingen in het algemeen functioneren volgens deze maatschappelijke normen. Deze conceptuele definitie leidt dus tot cijfertabellen waarin het onderscheid tussen deze maatschappelijke normen als dimensie worden opgenomen in plaats van de verschillende bestuursniveaus en publieke instellingen.

Beide conceptuele definities vertrekken vanuit dezelfde gebruikersbehoefte, maar bieden een verschillende invalshoek. In dit soort situaties is het dus essentieel dat je de gebruikersbehoeften voldoende scherp en expliciet formuleert. Enkel zo kunnen de meest geschikte conceptuele definities worden gekozen vóór de statistiek effectief in productie wordt genomen.
