...
statistieken op basis van administratieve bronnen en de specificiteit daarvan (vnl over spanningsveld tussen concept qua behoefte en de operationalisering. De operationele meting van een administratieve databank of de registratie heeft nooit statistiek tot doel, wel steeds een operationeel beleidsdoel bv: uitbetaling van werklozen, monitoren van werklozen, etc, ... we maken daar werkloosheidsduur statistieken van, ... , en dan heb je statistieken die gemeten worden oms tatistiek mee te maken (zowel registraties en survey) waarbij de behoefte, concept en operationalisering veel dichter kan aansluiten
